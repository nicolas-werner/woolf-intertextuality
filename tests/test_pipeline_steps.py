import pytest
from src.pipeline.steps.similarity_search import SimilaritySearchStep
from src.pipeline.steps.intertextual_analysis import IntertextualAnalysisStep
from src.pipeline.steps.document_indexing import DocumentIndexingStep
...
def test_similarity_search_step(pipeline, sample_documents):
    ...
    assert all(doc.meta.get('similarity_type') in ['similar', 'dissimilar'] for doc in results)
