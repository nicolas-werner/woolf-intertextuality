...
The experimental design tests two analytical approaches:

1. **Base Analysis (Naive Prompt)**:
   - Grounded in Kristeva's Intertextuality Theory
   - Universal literary analysis principles
   - General understanding of modernist techniques
   - Standard comparative literature methodology

2. **Enhanced Analysis (Expert Prompt)**:
   - Includes specific knowledge of Woolf's practices
   - Understanding of her feminist approach
   - Familiarity with her Homeric transformations
   - Recognition of her subtle integration techniques

This framework allows us to measure how specialized knowledge affects intertextual analysis quality and depth.
